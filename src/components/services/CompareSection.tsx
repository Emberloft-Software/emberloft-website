    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h2
            className="font-geist font-black text-black leading-tight max-w-2xl"
          ...
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 rounded-full bg-black/10 flex items-center justify-center">
              <svg width="8" height="8" viewBox="0 0 8 8" fill="none">
                <path d="M1 1L7 7M7 1L1 7" stroke="rgba(0,0,0,0.3)" strokeWidth="1.2" strokeLinecap="round" />
              </svg>
            </div>
            <span className="font-geist font-semibold text-black/30 text-xs tracking-widest uppercase">
              The rest
            </span>
          </div>
          <div className="flex items-center gap-2">
            <div
              ...
              style={{ backgroundColor: "#FB4B54" }}
            >
              <svg width="8" height="8" viewBox="0 0 8 8" fill="none">
                <path d="M1.5 4L3.5 6L6.5 2" stroke="white" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
            <span className="font-geist font-semibold text-black text-xs tracking-widest uppercase">
              Emberloft
            </span>
          </div>
        </div>
                ...
                style={{
                  backgroundColor:
                    hoveredRow === i
                      ? `${row.accent}18`
                      : `${row.accent}0C`,
                  border: `1px solid ${hoveredRow === i ? row.accent + "40" : "transparent"}`,
                }}
              >
                <span
                ...
                >
                  <svg width="9" height="9" viewBox="0 0 9 9" fill="none">
                    <path d="M1.5 4.5L3.5 6.5L7.5 2.5"
                      stroke={row.accent === "#EEBA0B" ? "black" : "white"}
                      strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </span>
                <p
                  className="font-geist font-semibold text-sm leading-snug text-black"
                >
                  {row.us}
                </p>
              </div>
        ...
        {/* Bottom CTA */}
        <div className="mt-[6vh] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5 pt-[4vh] border-t border-black/08">
          <p
            className="font-geist text-black/40 max-w-sm leading-relaxed"
          ...
          <a
            href="/contact"
            className="flex items-center gap-2 bg-[#FB4B54] text-white font-geist font-semibold text-sm px-6 py-3.5 rounded-full hover:brightness-110 transition-all shrink-0"
          >
