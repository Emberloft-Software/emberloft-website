    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p
            className="font-geist text-white/30 max-w-xs leading-relaxed md:text-right"
          ...
          {steps.map((step, i) => (
            <div
              ...
              style={{
                opacity: 0,
                backgroundColor:
                  activeStep === i ? `${step.accent}10` : "#161616",
                borderColor:
                  activeStep === i
                    ? `${step.accent}50`
            ...
            >
              ...
              <div className="flex items-center justify-between mb-[3vh]">
                <span
                  className="font-geist font-black text-xs"
              ...
              {/* Title */}
              <h3
                className="font-geist font-black text-white mb-3 leading-tight"
              ...
              {/* Body */}
              <p
                className="font-geist text-white/40 leading-relaxed mb-4 text-sm"
              >
                {step.body}
              </p>
              ...
              >
                ...
                <span
                  ...
                  style={{ color: activeStep === i ? step.accent : "rgba(255,255,255,0.2)" }}
                >
                  {step.detail}
                </span>
              </div>
