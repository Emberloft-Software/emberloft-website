      ...
      <section className="relative w-screen h-screen overflow-hidden bg-[#0A0A0A]">
        ...
        <div className="relative z-10 flex flex-col h-full px-[5vw]">
          ...
          <div className="flex-1 flex flex-col justify-center pt-28 md:pt-32">
            {/* Headline */}
            <div className="mb-8">
              <h1 className="font-geist text-[clamp(3rem,7vw,4.5rem)] font-bold leading-none tracking-tight text-[#F5F5F5]">
                Quiet Craft.
              </h1>
              <h1 className="font-instrument-serif text-[clamp(3rem,7vw,4.5rem)] font-normal leading-none tracking-tight text-[#F5F5F5] italic">
                Loud
              </h1>
              <h1 className="font-geist text-[clamp(3rem,7vw,4.5rem)] font-bold leading-none tracking-tight text-[#F5F5F5]">
                Results.
